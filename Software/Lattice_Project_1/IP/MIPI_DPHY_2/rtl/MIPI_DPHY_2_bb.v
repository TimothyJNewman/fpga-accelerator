...
module MIPI_DPHY_2 (sync_clk_i, sync_rst_i, lmmi_clk_i, lmmi_resetn_i,
    ...
    lp_tx_data_en_i, lp_tx_clk_p_i, lp_tx_clk_n_i, hs_tx_cil_ready_o,
    data_lane_ss_o, clk_p_io, clk_n_io, data_p_io, data_n_io, usrstdby_i,
    pd_dphy_i, pll_lock_o, clk_byte_o, ready_o)/* synthesis syn_black_box syn_declare_black_box=1 */;
    input  sync_clk_i;
    input  sync_rst_i;
    input  lmmi_clk_i;
    input  lmmi_resetn_i;
