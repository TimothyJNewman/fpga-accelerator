...
module PLL_1 (clki_i, 
    ...
    output clkos2_o ; 
    output lock_o ; 
    PLL_1_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
...
// Module : lscc_pll
//==========================================================================
module PLL_1_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                PLL_1_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module PLL_1_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
